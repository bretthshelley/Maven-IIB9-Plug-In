<h2><a name="Introduction"></a>Introduction to the IBM IIB version 9 Maven Build Lifecycle</h2>
The IIB9 Maven Plug-In is a 2017 rework of the IIB-Maven-Plug-In originally developed by the Swiss SBB.  Its code is derived from the original 
